...
$query_rs_data = "SELECT * FROM tampil_subgolongan ORDER BY sub_golongan ASC";
...
<div class=grid_12> 
   <br/>
   <a href='?mod=subgolongan&amp;act=add' class='button'>
    ...
    <div class="block-content">
      <table id="table-example" class="table" cellpadding="0" cellspacing="0" border="0">
        <thead>
          <tr> 
            <th>NO</th>
            <th>Kode SubGolongan</th>
            <th>Nama SubGolongan</th>
            <th>Golongan</th>
            <th>Tgl Posting</th>
            <th>User Posting</th>
            <th>Aksi</th>
         ...
         <?php $no = 1;?>
          <?php do { ?>
            <tr class=gradeX>
              ...
              <td><center>
                <?php echo $row_rs_data['sub_golongan']; ?>
              </center></td>
              <td><?php echo $row_rs_data['nm_subgolongan']; ?></td>
              ...
              <td   width="90"> 
              <a href="?mod=subgolongan&amp;act=edit&sub_golongan=<?php echo $row_rs_data['sub_golongan']; ?>"><img src="img/icons/packs/silk/16x16/pencil.png" width="16" height="16" alt="Edit" title="Edit" /></a> | 
              <a href="?mod=subgolongan&amp;act=delete&sub_golongan=<?php echo $row_rs_data['sub_golongan']; ?>" onclick="return confirm('Hapus Data <?php echo $row_rs_data['nm_subgolongan']; ?> ')">
