...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form")) {
  $insertSQL = sprintf("INSERT INTO penanggunjawab (nm_penanggungjawab,nm_kegiatan) VALUES (%s, %s)",
...
<div class="grid_12">
  <div class="block-border">
    ...
    <form action="<?php echo $editFormAction; ?>" name="form"  method="POST" enctype="multipart/form-data" class="block-content form">
      <div class="_50">
        <p>Penanggung Jawab
          <input id="textfield" name="nm_penanggungjawab" class="required" type="text" value="" />
        </p>
        <p>Kegiatan
          <input id="textfield2" name="nm_kegiatan" class="required" type="text" value="" />
        </p>
      </div>
      <div class="clear"></div>
