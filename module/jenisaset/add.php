...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form")) {
  $insertSQL = sprintf("INSERT INTO harta_berwujud (kode_harta, nm_harta, ket, tgl_posting, user_posting) VALUES (%s, %s, %s, %s, %s)",
...
$query = "SELECT MAX(kode_harta) as max FROM harta_berwujud ";
    ...
    <form action="<?php echo $editFormAction; ?>" name="form"  method="POST" enctype="multipart/form-data" class="block-content form">
      <div class="_25">
        <p>
          ...
          <input id="textfield2" name="kode_harta" class="required" type="text" value="<?php echo $newID ?>" />
        </p>
      </div>
      <div class="_100">
        <p>
          ...
          <input id="textfield" name="nm_harta" class="required" type="text" value="" />
      ...
      <div class="_100">
        <p>
          ...
          <input type="text" name="ket" id="merk" />
        </p>
      </div>
      <div class="_50">
        <p>
