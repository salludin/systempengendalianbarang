...
$query_rs_data = sprintf("SELECT * FROM aset WHERE kode_barang LIKE %s OR nm_barang LIKE %s", GetSQLValueString("%" . $colname_rs_data . "%", "text"),GetSQLValueString("%" . $colname_rs_data . "%", "text"));
    ...
    <tbody>
      ...
      <?php do { ?>
        <tr class="gradeX">
          ...
          <td ><?php echo $row_rs_data['merk']; ?></td>
          <td ><?php echo $row_rs_data['tipe']; ?></td>
          <td  width="50"><center>
            <?php echo $row_rs_data['tahun']; ?>
          </center></td>
