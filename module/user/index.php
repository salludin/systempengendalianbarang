...
$query_rs_data = "SELECT * FROM user_login";
...
<div class=grid_12> 
   <br/>
   <a href='?mod=user&amp;act=add' class='button'>
         ...
         <?php $no = 1;?>
          <?php do { ?>
            <tr class=gradeX>
              ...
              <td><center>
                <?php echo $row_rs_data['user_id']; ?>
              </center></td>
              <td><?php echo $row_rs_data['user_name']; ?></td>
              <td ><?php echo $row_rs_data['level']; ?></td>
              <td ><?php echo $row_rs_data['kode_cabang']; ?></td>
              <td   width="90"> 
                <a href="?mod=user&amp;act=edit&user_id=<?php echo $row_rs_data['user_id']; ?>"><img src="img/icons/packs/silk/16x16/pencil.png" width="16" height="16" alt="Edit" title="Edit" /></a> | 
                <a href="?mod=user&amp;act=delete&user_id=<?php echo $row_rs_data['user_id']; ?>" onclick="return confirm('Hapus Data <?php echo $row_rs_data['user_name']; ?> ?')">
