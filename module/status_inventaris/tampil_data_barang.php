      ...
      <?php do { ?>
        <tr class="gradeX">
          ...
          <td   width="90"><div align="center">
            <a href="javascript:void(0);" onclick="tambah_barang('<?php echo $row_rs_data['kode_inventarisasi']; ?>');"><img src="img/icons/packs/fugue/16x16/tick-red.png" width="16" height="16" alt="Pilih" id="pilih" /> </a>
          </div></td>
