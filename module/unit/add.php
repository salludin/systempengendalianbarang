...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form")) {
  $insertSQL = sprintf("INSERT INTO unit_kerja (kode_unit, nm_unit, keterangan, user_posting, tgl_posting) VALUES (%s, %s, %s, %s, %s)",
    ...
    <form action="<?php echo $editFormAction; ?>" name="form"  method="POST" enctype="multipart/form-data" class="block-content form">
      <div class="_25">
        <p>
          ...
          <input id="textfield2" name="kode_unit" class="required" type="text" value="<?php echo $newID ?>" />
        </p>
      </div>
      <div class="_100">
        <p>
          ...
          <input id="textfield" name="nm_unit" class="required" type="text" value="" />
