...
$query_rs_data = "SELECT * FROM unit_kerja ORDER BY kode_unit ASC";
...
<div class=grid_12> 
   <br/>
   <a href='?mod=unit&amp;act=add' class='button'>
         ...
         <?php $no = 1;?>
          <?php do { ?>
            <tr class=gradeX>
              ...
              <td><center>
                <?php echo $row_rs_data['kode_unit']; ?>
              </center></td>
              ...
              <td   width="90"> 
              <a href="?mod=unit&amp;act=edit&kode_unit=<?php echo $row_rs_data['kode_unit']; ?>"><img src="img/icons/packs/silk/16x16/pencil.png" width="16" height="16" alt="Edit" title="Edit" /></a> | 
              <a href="?mod=unit&amp;act=delete&kode_unit=<?php echo $row_rs_data['kode_unit']; ?>" onclick="return confirm('Hapus Data <?php echo $row_rs_data['nm_unit']; ?> ?')">
