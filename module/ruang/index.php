...
$query_rs_data = "SELECT * FROM ruangan ORDER BY kode_ruangan ASC";
...
<div class=grid_12> 
   <br/>
   <a href='?mod=ruang&amp;act=add' class='button'>
         ...
         <?php $no = 1;?>
          <?php do { ?>
            <tr class=gradeX>
              ...
              <td><center>
                <?php echo $row_rs_data['kode_ruangan']; ?>
              </center></td>
              <td><?php echo $row_rs_data['nm_ruangan']; ?></td>
              <td ><?php echo $row_rs_data['keterangan']; ?></td>
              <td ><?php echo $row_rs_data['user_posting']; ?></td>
              <td  width="50"><center>
                <?php echo $row_rs_data['tgl_posting']; ?>
              </center></td>
              <td   width="90"> 
              <a href="?mod=ruang&amp;act=edit&kode_ruangan=<?php echo $row_rs_data['kode_ruangan']; ?>"><img src="img/icons/packs/silk/16x16/pencil.png" width="16" height="16" alt="Edit" title="Edit" /></a> | 
              <a href="?mod=ruang&amp;act=delete&kode_ruangan=<?php echo $row_rs_data['kode_ruangan']; ?>" onclick="return confirm('Hapus Data <?php echo $row_rs_data['nm_ruangan']; ?> ? ')">
