...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form")) {
  $insertSQL = sprintf("INSERT INTO ruangan (kode_ruangan, nm_ruangan, keterangan, user_posting, tgl_posting) VALUES (%s, %s, %s, %s, %s)",
...
$query = "SELECT MAX(kode_ruangan) as max FROM ruangan ";
    ...
    <form action="<?php echo $editFormAction; ?>" name="form"  method="POST" enctype="multipart/form-data" class="block-content form">
      <div class="_25">
        <p>
          ...
          <input id="textfield2" name="kode_ruangan" class="required" type="text" value="<?php echo $newID ?>" />
        </p>
      </div>
      <div class="_100">
        <p>
          <label for="textarea">Nama Ruang</label>
          <input id="textfield" name="nm_ruangan" class="required" type="text" value="" />
        </p>
      </div>
      <div class="_100">
        <p>Keterangan
