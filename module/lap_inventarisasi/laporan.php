...
$objPHPExcel->getActiveSheet()->setCellValue('A9', "NO")
							  ->setCellValue('B9', "KODE INVENTARISASI")
							  ->setCellValue('C9', "NAMA ASET")
							  ->setCellValue('D9', "RUANGAN")
							  ->setCellValue('E9', "UNIT")
							  ->setCellValue('F9', "JUMLAH")
...
// query database
$SQL = mysql_query("select * from tampil_inventarisasi order by kode_inventarisasi");
...
while($row = mysql_fetch_array($SQL, MYSQL_ASSOC)){
	$no++;
	$row_array['no'] 		  			= $no;
	$row_array['kode_inventarisasi'] 	= $row['kode_inventarisasi'];
	...
	$row_array['nm_status'] 	  		= $row['nm_status'];
...
// Set fills
$objPHPExcel->getActiveSheet()->getStyle('A9:G9')->getFill()->setFillType(PHPExcel_Style_Fill::FILL_SOLID);
$objPHPExcel->getActiveSheet()->getStyle('A9:G9')->getFill()->getStartColor()->setARGB('FF808080');
...
$objPHPExcel->getActiveSheet()->getStyle('A2:G5')->getFont()->setName('Arial');
$objPHPExcel->getActiveSheet()->getStyle('A2:G5')->getFont()->setSize(14);
$objPHPExcel->getActiveSheet()->getStyle('A2:G5')->getFont()->setBold(true);
$objPHPExcel->getActiveSheet()->getStyle('A3:G5')->getFont()->setSize(13);
...
header('Content-Disposition: attachment;filename="DATA_INVENTARISASI"'.date("d-F-Y").'".xlsx"');
