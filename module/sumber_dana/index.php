...
$query_rs_data = "SELECT * FROM sumber_dana";
...
<div class=grid_12> 
   <br/>
   <a href='?mod=sumber_dana&amp;act=add' class='button'>
         ...
         <?php $no = 1;?>
          <?php do { ?>
            <tr class=gradeX>
              ...
              <td><center>
                <?php echo $row_rs_data['id_dana']; ?>
              </center></td>
              <td><?php echo $row_rs_data['nm_dana']; ?></td>
                <td><?php echo $row_rs_data['jumlah']; ?></td>
              <td   width="90"> 
                <a href="?mod=sumber_dana&amp;act=edit&id_dana=<?php echo $row_rs_data['id_dana']; ?>"><img src="img/icons/packs/silk/16x16/pencil.png" width="16" height="16" alt="Edit" title="Edit" /></a> | 
                <a href="?mod=sumber_dana&amp;act=delete&id_dana=<?php echo $row_rs_data['id_dana']; ?>" onclick="return confirm('Hapus Data <?php echo $row_rs_data['nm_dana']; ?> ?')">
