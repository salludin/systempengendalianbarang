...
$objPHPExcel->getProperties()->setCreator("Fauzan Azis")
							 ...
							 ->setTitle("Data mutasi")
							 ->setSubject("Data mutasi")
							 ->setDescription("Laporan Data mutasi ")
							 ->setKeywords("Data mutasi")
							 ->setCategory("Data mutasi");
...
$objPHPExcel->getActiveSheet()->setCellValue('A9', "NO")
							  ->setCellValue('B9', "ID")
							  ->setCellValue('C9', "TANGGAL MUTASI")
							  ->setCellValue('D9', "KODE ASET")
							  ->setCellValue('E9', "NAMA ASET")
							  ->setCellValue('F9', "RUANG LAMA")
							  ->setCellValue('G9', "RUANG BARU")
							  ->setCellValue('H9', "UNIT LAMA")
							  ->setCellValue('I9', "UNIT BARU")
							;
...
// query database
$SQL = mysql_query("select * from tampil_mutasi ");
...
while($row = mysql_fetch_array($SQL, MYSQL_ASSOC)){
	...
	$row_array['tgl_mutasi']    	= $row['tgl_mutasi'];
	$row_array['kode_aset']    		= $row['kode_aset'];
	$row_array['nm_barang'] 	  	= $row['nm_barang'];
	$row_array['ruanglama'] 		= $row['ruanglama'];
	$row_array['ruangbaru'] 	  	= $row['ruangbaru'];
	$row_array['unitlama'] 	  		= $row['unitlama'];
	$row_array['unitbaru'] 	  		= $row['unitbaru'];
...
$objPHPExcel->getActiveSheet()->setCellValue('A2', "DAFTAR DATA INVENTARISASI");
...
$objPHPExcel->getActiveSheet()->getStyle('A2:I5')->getFont()->setSize(14);
$objPHPExcel->getActiveSheet()->getStyle('A2:I5')->getFont()->setBold(true);
$objPHPExcel->getActiveSheet()->getStyle('A3:I5')->getFont()->setSize(13);
...
// Judul Center
$objPHPExcel->getActiveSheet()->getStyle('A2:J6')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
 

// Redirect output to a client’s web browser (Excel2007)
header('Content-Type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
header('Content-Disposition: attachment;filename="DATA_MUTASI"'.date("d-F-Y").'".xlsx"');
