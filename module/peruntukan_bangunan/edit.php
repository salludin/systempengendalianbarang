...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form")) {
  $updateSQL = sprintf("UPDATE peruntukan_bangunan SET nm_peruntukan=%s WHERE id_peruntukan=%s",
                       GetSQLValueString($_POST['nm_peruntukan'], "text"),
...
$colname_rs_edit = "-1";
if (isset($_GET['id_peruntukan'])) {
  $colname_rs_edit = $_GET['id_peruntukan'];
}
mysql_select_db($database_koneksi, $koneksi);
$query_rs_edit = sprintf("SELECT * FROM peruntukan_bangunan WHERE id_peruntukan = %s", GetSQLValueString($colname_rs_edit, "int"));
...
<div class=grid_12> 
   <br/>
<a href='?mod=peruntukan_bangunan' class='button red'>
   <span>Kembali</span>
   </a></div>
...
<div class="grid_12">
  <div class="block-border">
    <div class="block-header">
      <h1>Edit Peruntukan Bangunan</h1>
      <span></span> </div>
      
    <form action="<?php echo $editFormAction; ?>" name="form"  method="POST" enctype="multipart/form-data" class="block-content form">
      <div class="_50">
        <p>Peruntukan Bangunan
          <input id="textfield" name="nm_peruntukan" class="required" type="text" value="<?php echo $row_rs_edit['nm_peruntukan']; ?>" />
        </p>
      </div>
      <div class="clear"></div>
      ...
      <div class="block-actions">
        <ul class="actions-left">
          <li><a class="button red"  href="?mod=peruntukan_bangunan">Kembali</a></li>
        </ul>
      ...
      <input name="id_peruntukan" type="hidden" id="id_peruntukan" value="<?php echo $row_rs_edit['id_peruntukan']; ?>" />
