...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form")) {
  $insertSQL = sprintf("INSERT INTO peruntukan_bangunan (nm_peruntukan) VALUES (%s)",
...
<div class="grid_12">
  <div class="block-border">
    <div class="block-header">
      <h1>Tambah Peruntukan Bangunan</h1>
      <span></span> </div>
    ...
    <form action="<?php echo $editFormAction; ?>" name="form"  method="POST" enctype="multipart/form-data" class="block-content form">
      <div class="_50">
        <p>Peruntukan Bangunan
          <input id="textfield" name="nm_peruntukan" class="required" type="text" value="" />
        </p>
      </div>
      <div class="clear"></div>
