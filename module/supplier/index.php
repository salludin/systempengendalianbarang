...
<div class=grid_12> 
   <br/>
   <a href='?mod=supplier&amp;act=add' class='button'>
         ...
         <?php $no = 1;?>
          <?php do { ?>
            <tr class=gradeX>
              ...
              <td><center>
                <?php echo $row_rs_data['kode_suplier']; ?>
              </center></td>
              <td><?php echo $row_rs_data['nm_suplier']; ?></td>
              <td ><?php echo $row_rs_data['alamat']; ?></td>
              <td ><?php echo $row_rs_data['kota']; ?></td>
              <td  width="50"><center>
                <?php echo $row_rs_data['telepon']; ?>
              </center></td>
              <td   width="90"> 
              <a href="?mod=supplier&amp;act=edit&kode_suplier=<?php echo $row_rs_data['kode_suplier']; ?>"><img src="img/icons/packs/silk/16x16/pencil.png" width="16" height="16" alt="Edit" title="Edit" /></a> | 
              <a href="?mod=supplier&amp;act=delete&kode_suplier=<?php echo $row_rs_data['kode_suplier']; ?>" onclick="return confirm('Hapus Data <?php echo $row_rs_data['nm_suplier']; ?> ')">
